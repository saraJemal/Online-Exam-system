<%-- 
    Document   : editUsers
    Created on : 19 Sept 2024, 20:05:39
    Author     : new
--%>
...
<html>
    ...
    <body>
        ...
        <form name="Idform" action="editUsers.jsp" method="POST">
            <table border="0">
        ...
        <form name="updUform" action="editUserJava.jsp" method="POST">
